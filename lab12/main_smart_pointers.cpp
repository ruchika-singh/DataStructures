...
int main() {
  ...
  dsSharedPtr<Balloon> temp2 = henry2;
  georgette2->addRope(henry2);
  georgette2->print();
  henry2->print();

  georgette2->addRope(henry2);
  henry2 = dsSharedPtr<Balloon>(new Balloon(("Tigger")));
  georgette2->addRope(henry2);
  georgette2->print();
  henry2->print();

  dsSharedPtr<Balloon> isabelle2(new Balloon("Shrek"));
  dsSharedPtr<Balloon> temp3 = isabelle2;
  henry2->addRope(isabelle2);
  isabelle2 = dsSharedPtr<Balloon>(new Balloon("Barney the Purple Dinosaur"));
